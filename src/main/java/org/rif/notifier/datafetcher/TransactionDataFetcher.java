...
@Service
public class TransactionDataFetcher extends DataFetcher {

    @Async
    @Override
    public CompletableFuture<FetchedData> fetch(SubscriptionChannel subscriptionChannel) {
        long start  = System.currentTimeMillis();
        System.out.println(Thread.currentThread().getId() + " - Start Transaction Data fetching");
        ...
        System.out.println( Thread.currentThread().getId() + " - End Transaction Data fetching time = " + (end-start));
